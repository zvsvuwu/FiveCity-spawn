...
Citizen.CreateThread(function()
	while true do
		...
		if NetworkIsPlayerActive(PlayerId()) then
			TriggerEvent("esx:playerSessionStarted")
            TriggerServerEvent("esx:playerSessionStarted")
			break
		end
	end
end)
